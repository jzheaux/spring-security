 ...
 * @since 2.0
 */
public class PreAuthenticatedAuthenticationManager implements AuthenticationManager, Ordered {

	private final Log logger = LogFactory.getLog(getClass());

	private final AuthenticationUserDetailsService<PreAuthenticatedAuthenticationToken> preAuthenticatedUserDetailsService;
	...
	public PreAuthenticatedAuthenticationManager(AuthenticationUserDetailsService<PreAuthenticatedAuthenticationToken> preAuthenticatedUserDetailsService) {
		this.preAuthenticatedUserDetailsService = preAuthenticatedUserDetailsService;
	}

	public PreAuthenticatedAuthenticationManager(UserDetailsService userDetailsService) {
		this(new UserDetailsByNameServiceWrapper<>(userDetailsService));
	}
