...
public class MethodSecurityBeanDefinitionParser implements BeanDefinitionParser {
	...
	private void registerBeanDefinition(String beanName, String aspectName, String aspectBeanName,
			BeanDefinitionRegistry registry) {
		if (!registry.containsBeanDefinition(beanName)) {
			return;
		}
		BeanDefinition interceptor = registry.getBeanDefinition(beanName);
		BeanDefinitionBuilder aspect = BeanDefinitionBuilder.rootBeanDefinition(aspectName);
