 ...
 *
 * <ul>
 * 	<li>{@link Saml2ServiceProviderConfiguration} when the {@code spring-security-saml2-service-provider} module is present on the classpath</li>
 * </ul>
 *
...
final class Saml2ImportSelector implements ImportSelector {
	...
	public String[] selectImports(AnnotationMetadata importingClassMetadata) {
		...
		if (saml2ServiceProviderPresent) {
			imports.add("org.springframework.security.config.annotation.web.configuration.Saml2ServiceProviderConfiguration");
		}
