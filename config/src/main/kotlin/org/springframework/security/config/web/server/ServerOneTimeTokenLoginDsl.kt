 ...
 * @since 6.4
 * @property oneTimeTokenService configures the [ReactiveOneTimeTokenService] used to generate and consume
...
class ServerOneTimeTokenLoginDsl {
    ...
    var oneTimeTokenService: ReactiveOneTimeTokenService? = null
