...
[[oauth2resourceserver-opaque-authorization-manager-factory]]
=== Using an `OAuth2AuthorizationManagerFactory`
...
----
@Bean
fun oauth2(): OAuth2AuthorizationManagerFactory {
...
[source,java,role="primary"]
----
@PreAuthorize("@oauth2.hasScope('messages')")
public List<Message> getMessages(...) {}
----
