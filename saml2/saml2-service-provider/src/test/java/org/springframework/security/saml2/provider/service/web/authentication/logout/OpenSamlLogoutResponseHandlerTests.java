...
public class OpenSamlLogoutResponseHandlerTests {
	...
	public void handleWhenAuthenticatedThenHandles() {
		...
		TestOpenSamlObjects.signed(logoutResponse, TestSaml2X509Credentials.assertingPartySigningCredential(),
		...
		request.setParameter("SAMLRequest", Saml2Utils.samlEncode(Saml2Utils.samlDeflate(serialize(logoutResponse))));
		OpenSamlLogoutResponseHandler handler = new OpenSamlLogoutResponseHandler();
