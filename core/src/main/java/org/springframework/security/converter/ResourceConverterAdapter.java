...
class ResourceConverterAdapter<T> implements Converter<String, T> {
	...
	/**
	 * Construct a {@link ResourceConverterAdapter} with the provided parameters
	 * @param delegate converts a stream of key material into a {@link Key}
	 */
	ResourceConverterAdapter(Converter<InputStream, T> delegate) {
